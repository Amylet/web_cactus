...
?>
<form id="form1" name="form1" method="POST" action="exec_product_type.php">

<label for="product_type_name">ประเภทสินค้า</label>
<input id="product_type_name" name="product_type_name" type="text" class="form-control input-lg" placeholder="ชื่อประเภทสินค้า" autocomplete=off >

<br>

<input type="hidden" id="chk" name ="chk" value="insert_product_type"> 
<button type="submit" onclick="return confirm('ยืนยันการบันทึกข้อมูล')" class="btn btn-success btn-block">เพิ่มข้อมูล</button>
</form>
