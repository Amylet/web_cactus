...
--
-- Host: localhost
-- Generation Time: Oct 10, 2021 at 04:48 PM
...
--
-- Table structure for table `basket_shop`
--

CREATE TABLE `basket_shop` (
  `list_id` int(20) NOT NULL,
  `shop_id` varchar(20) NOT NULL,
  `product_type_id` varchar(20) NOT NULL,
  `product_id` varchar(20) NOT NULL,
  `person_authen_id` varchar(20) NOT NULL,
  `basket_name` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `basket_shop`
--

INSERT INTO `basket_shop` (`list_id`, `shop_id`, `product_type_id`, `product_id`, `person_authen_id`, `basket_name`) VALUES
(8, '10', '1', '14', '1', 'LB2178'),
(9, '10', '1', '15', '1', 'ยิมโน Pink Diamond'),
(14, '10', '1', '18', '3', 'ถังทองหนามสั้น'),
(18, '12', '3', '23', '2', 'เมล็ด T-rex MIX'),
(19, '10', '3', '17', '3', 'กระถางทรงสูง');
...
CREATE TABLE `buy_sell` (
  `oder_list` varchar(50) NOT NULL,
  `person_authen_id` varchar(20) DEFAULT NULL,
  `buy_sell_status` varchar(20) DEFAULT NULL,
  `order_time` varchar(20) NOT NULL,
  `person_authen_name` varchar(50) NOT NULL
...
INSERT INTO `buy_sell` (`oder_list`, `person_authen_id`, `buy_sell_status`, `order_time`, `person_authen_name`) VALUES
('40', '3', 'รอการยืนยัน', '15:05:19: 09-10-2021', 'ออย อิอิ'),
('41', '3', 'รอการยืนยัน', '15:09:35: 09-10-2021', 'ออย อิอิ');
...
CREATE TABLE `order_pay` (
  `oder_list` int(50) NOT NULL,
  `person_authen_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `bank_account` varchar(20) NOT NULL,
  `order_money` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `order_img` varchar(40) NOT NULL,
  `provinces` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `amphures` varchar(20) NOT NULL,
  `districts` varchar(20) NOT NULL,
  `zip_code` varchar(20) NOT NULL,
  `address_details` varchar(20) NOT NULL,
  `order_time` varchar(20) NOT NULL,
  `person_authen_name` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `order_pay` (`oder_list`, `person_authen_id`, `bank_account`, `order_money`, `order_img`, `provinces`, `amphures`, `districts`, `zip_code`, `address_details`, `order_time`, `person_authen_name`) VALUES
(40, '3', 'bangkokbank', '58', '', '13', '161', '', '22110', '556', '15:05:18: 09-10-2021', 'ออย อิอิ'),
(41, '3', 'kasikornbank', '58', '/58.jpg', '12', '152', '', '21130', '556', '15:09:34: 09-10-2021', 'ออย อิอิ');

-- --------------------------------------------------------

--
-- Table structure for table `person_authen`
--

CREATE TABLE `person_authen` (
  `person_authen_id` int(11) NOT NULL,
  `person_authen_cid` varchar(13) DEFAULT NULL,
  `person_authen_fname` varchar(50) DEFAULT NULL,
  `person_authen_lname` varchar(50) DEFAULT NULL,
  `person_authen_phone` int(10) DEFAULT NULL,
  `person_authen_email` varchar(50) DEFAULT NULL,
  `person_authen_password` varchar(12) DEFAULT NULL,
  `person_authen_status` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `person_authen`
--

INSERT INTO `person_authen` (`person_authen_id`, `person_authen_cid`, `person_authen_fname`, `person_authen_lname`, `person_authen_phone`, `person_authen_email`, `person_authen_password`, `person_authen_status`) VALUES
(1, '1710000000001', 'ลูลูช', 'แลมเพอรูจ', 980000001, 'Lelouch@gmail.com', '1111', 'Admin'),
(2, '1710000000002', 'แคคตัส', 'แคคตัส', 900000002, 'cactus@email.com', '1111', 'User'),
(3, '1700000200000', 'ออย', 'อิอิ', 801111111, 'asd@gmail.com', '1111', 'User');
...
CREATE TABLE `product` (
  ...
  `product_price` varchar(7) DEFAULT NULL,
...
INSERT INTO `product` (`product_id`, `product_name`, `product_details`, `product_type`, `product_price`, `product_img`, `shop_id`) VALUES
(14, 'LB2178', 'LB2178 แท้', 1, '220', './img/product/14.jpg', 10),
(15, 'ยิมโน Pink Diamond', 'ยิมโน Pink Diamond (ไม้ชำหน่อ)', 1, '50', './img/product/15.jpg', 10),
(16, 'แมมขนแกะ', 'Mammillaria bocasana cv. Multilanata (ดอกสีขาว-ชมพู)', 1, '20', './img/product/16.jpg', 10),
(17, 'กระถางทรงสูง', 'ขนาด สูง 6 นิ้ว x ปากกว้าง 5.5 นิ้ว', 3, '28', './img/product/17.jpg', 10),
(18, 'ถังทองหนามสั้น', 'Echinocactus grusonii brevispinus', 1, '30', './img/product/18.jpg', 10),
(19, 'ยิมโนด่าง', 'ยิมโนด่าง ไม้เมล็ดยกพอทสีสดๆ', 1, '1650', './img/product/19.jpg', 12),
(20, 'เพอร์ไลท์', 'เพอร์ไลท์ 20 ลิตร ขนาด 4-8 mm. ใช้ผสมดินสำหรับปลูกแคคตัส', 3, '150', './img/product/20.jpg', 12),
(21, 'เมล็ดแอสโต MIX', 'จำนวน 500 เมล็ด เก็บเมล็ดวันที่ 30 ก.ย. 64', 2, '250', './img/product/21.jpg', 12),
(22, 'กระถาง', 'ขนาด 2 นิ้ว สีดำ', 3, '2', './img/product/22.jpg', 12),
(23, 'เมล็ด T-rex MIX', '100++ เมล็ด **พ่อแม่ T-rex T-ruk Kingkong Godji มาจุนก้า เมล็ดเก็บล้างใหม่ อัตราการงอก 70-90%', 3, '135', './img/product/23.jpg', 12),
(24, 'กระถางแปดเหลี่ยม', 'ขนาด 2 นิ้ว จำนวน 50 ใบ (คละสี)', 3, '100', './img/product/24.jpg', 12);
...
CREATE TABLE `product_type` (
  ...
  `product_type_name` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `shop` (
  ...
  `provinces` varchar(2) NOT NULL,
  `amphures` varchar(5) NOT NULL,
  `districts` varchar(6) NOT NULL,
...
INSERT INTO `shop` (`shop_id`, `shop_name`, `person_authen_id`, `bank_account`, `bank_account_number`, `provinces`, `amphures`, `districts`, `zip_code`, `address_details`) VALUES
(10, 'LOVE Cactus', 2, 'krungthaibank', '7000000001', '56', '784', '710309', '71220', '85/5 ม.12'),
(12, 'TREE PLUS', 3, 'krungthaibank', '565454578', '6', '91', '150202', '14140', '556'),
(13, 'ต้นไม้', 1, 'bangkokbank', '55565555', '3', '59', '120203', '11130', 'ฟหกหฟ');
...
--
-- Indexes for table `basket_shop`
--
ALTER TABLE `basket_shop`
...
--
-- Indexes for table `person_authen`
--
ALTER TABLE `person_authen`
  ADD PRIMARY KEY (`person_authen_id`);
...
--
-- AUTO_INCREMENT for table `basket_shop`
--
ALTER TABLE `basket_shop`
  MODIFY `list_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `order_pay`
  MODIFY `oder_list` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `person_authen`
--
ALTER TABLE `person_authen`
  MODIFY `person_authen_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
